...
/*
var APIKeyInstaller = require('./setup-ip.js')
var apiKeyInstaller = new APIKeyInstaller()
 ...
 */
/*
apiKeyInstaller.install(config.email, config.password).then(function (setup) {
